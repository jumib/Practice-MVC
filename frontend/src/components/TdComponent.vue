  ...
  methods: {
    onClickTd () {
      ...
      if (
        ...
        this.tableData[this.rowIndex][3] === this.turn &&
        this.tableData[this.rowIndex][4] === this.turn
      ) {
        win = true
      }
      if (
        ...
        this.tableData[3][this.cellIndex] === this.turn &&
        this.tableData[4][this.cellIndex] === this.turn
      ) {
        win = true
      }
      if (
        ...
        this.tableData[3][3] === this.turn &&
        this.tableData[4][4] === this.turn
      ) {
        win = true
      }
      if (
        this.tableData[0][4] === this.turn &&
        this.tableData[1][3] === this.turn &&
        this.tableData[2][2] === this.turn &&
        this.tableData[3][1] === this.turn &&
        this.tableData[4][0] === this.turn
      ) {
        win = true
      }
      if (win) {
